...
void Core_t::dump_init ( FILE* f ) {
  ...
  fputs("$var wire 13 \x4a\x26 io_dmem_addr $end\n", f);
  fputs("$var wire 13 \x4b\x26 io_imem_addr $end\n", f);
  ...
  fputs("$var wire 12 \x40\x26 exe_reg_csr_addr $end\n", f);
  fputs("$var wire 13 \x42\x26 io_dmem_addr $end\n", f);
  fputs("$var wire 13 \x44\x26 io_imem_r_addr $end\n", f);
  fputs("$var wire 13 \x47\x26 io_imem_rw_addr $end\n", f);
  ...
  fputs("$var wire 13 \x41\x26 io_dmem_addr $end\n", f);
  fputs("$var wire 13 \x46\x26 io_imem_rw_addr $end\n", f);
  fputs("$var wire 13 \x49\x26 io_imem_r_addr $end\n", f);
  ...
  fputs("$var wire 12 \x3f\x26 io_rw_addr $end\n", f);
  ...
  fputs("$var wire 13 \x45\x26 io_core_r_addr $end\n", f);
  fputs("$var wire 13 \x48\x26 io_core_rw_addr $end\n", f);
  ...
  fputs("$var wire 13 \x43\x26 io_core_addr $end\n", f);
...
void Core_t::clock_lo ( dat_t<1> reset ) {
  ...
  val_t T120;
  { T120 = Core_datapath_loadstore__io_addr.values[0] >> 12;}
  T120 = T120 & 0x7L;
  val_t T121;
  T121 = (T120 >> 0) & 1;
  val_t T122;
  ...
  val_t T143;
  { T143 = Core_datapath_loadstore__io_addr.values[0] >> 12;}
  T143 = T143 & 0x7L;
  val_t T144;
  T144 = (T143 >> 0) & 1;
  val_t T145;
  ...
  Core_datapath_loadstore__io_imem_r_addr.values[0] = Core_datapath_loadstore__io_imem_r_addr.values[0] & 0x1fffL;
...
void Core_api_t::init_mapping_table (  ) {
  ...
  dat_table["Core.datapath.loadstore.io_dmem_addr"] = new dat_api<13>(&mod_typed->Core_datapath_loadstore__io_dmem_addr, "Core.datapath.loadstore.io_dmem_addr", "");
  dat_table["Core.datapath.io_dmem_addr"] = new dat_api<13>(&mod_typed->Core_datapath__io_dmem_addr, "Core.datapath.io_dmem_addr", "");
  dat_table["Core.dmem.io_core_addr"] = new dat_api<13>(&mod_typed->Core_dmem__io_core_addr, "Core.dmem.io_core_addr", "");
  ...
  mem_table["Core.dmem.dspm"] = new mem_api<32, 8192>(&mod_typed->Core_dmem__dspm, "Core.dmem.dspm", "");
  ...
  dat_table["Core.datapath.io_imem_r_addr"] = new dat_api<13>(&mod_typed->Core_datapath__io_imem_r_addr, "Core.datapath.io_imem_r_addr", "");
  dat_table["Core.imem.io_core_r_addr"] = new dat_api<13>(&mod_typed->Core_imem__io_core_r_addr, "Core.imem.io_core_r_addr", "");
  ...
  dat_table["Core.datapath.loadstore.io_imem_rw_addr"] = new dat_api<13>(&mod_typed->Core_datapath_loadstore__io_imem_rw_addr, "Core.datapath.loadstore.io_imem_rw_addr", "");
  dat_table["Core.datapath.io_imem_rw_addr"] = new dat_api<13>(&mod_typed->Core_datapath__io_imem_rw_addr, "Core.datapath.io_imem_rw_addr", "");
  dat_table["Core.imem.io_core_rw_addr"] = new dat_api<13>(&mod_typed->Core_imem__io_core_rw_addr, "Core.imem.io_core_rw_addr", "");
  mem_table["Core.imem.ispm"] = new mem_api<32, 8192>(&mod_typed->Core_imem__ispm, "Core.imem.ispm", "");
  ...
  dat_table["Core.datapath.loadstore.io_imem_r_addr"] = new dat_api<13>(&mod_typed->Core_datapath_loadstore__io_imem_r_addr, "Core.datapath.loadstore.io_imem_r_addr", "");
  ...
  dat_table["Core.io_dmem_addr"] = new dat_api<13>(&mod_typed->Core__io_dmem_addr, "Core.io_dmem_addr", "");
  ...
  dat_table["Core.io_imem_addr"] = new dat_api<13>(&mod_typed->Core__io_imem_addr, "Core.io_imem_addr", "");
}
